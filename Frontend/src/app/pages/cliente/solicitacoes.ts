            ...
            @if (loading) {
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex gap-5">
                        ...
                        <p-button label="Nova Solicitação" icon="pi pi-plus" disabled="true" size="large" (click)="newRequestVisible = true;"/>
                    </div>
                </div>
