...
@Component({
    ...
    template: `<a class="flex items-center" href="#">
            <svg viewBox="0 0 78 78" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-12 mr-2">
            ...
            <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">FIXSYS</span>
        </a>
